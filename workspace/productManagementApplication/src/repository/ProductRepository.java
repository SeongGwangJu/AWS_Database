					...
					switch (searchOption) {
						case "전체":
							whereSql = " "
									...
									+ "or cat.category_name like concat('%', ?, '%')";
							break;
						...
						case "색상":
							whereSql = "and cot.color_name like concat('%', ?, '%')";
							break;
							
						case "카테고리":
							whereSql = "and cat.category_name like concat('%', ?, '%')";
							break;
					}
