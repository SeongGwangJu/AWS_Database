...
--
-- Dumping events for database 'test_0725'
--

--
-- Dumping routines for database 'test_0725'
--
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `FIND_USER_BY_USERNAME`(
	IN VS_USERNAME VARCHAR(50)
)
BEGIN
